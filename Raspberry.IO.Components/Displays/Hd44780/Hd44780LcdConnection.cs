...
namespace Raspberry.IO.Components.Displays.Hd44780
{
    ...
    public class Hd44780LcdConnection : IDisposable
    {
        ...
        {
            get => (displayFlags & DisplayFlags.DisplayOn) == DisplayFlags.DisplayOn;
            set
            {
                if (value)
        ...
        {
            get => (displayFlags & DisplayFlags.CursorOn) == DisplayFlags.CursorOn;
            set
            {
                if (value)
        ...
        {
            get => (displayFlags & DisplayFlags.BlinkOn) == DisplayFlags.BlinkOn;
            set
            {
                if (value)
