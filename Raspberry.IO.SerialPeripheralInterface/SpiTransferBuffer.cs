...
namespace Raspberry.IO.SerialPeripheralInterface
{
    ...
    public class SpiTransferBuffer : ISpiTransferBuffer
    {
        ...
        public bool ChipSelectChange {
            get => control.ChipSelectChange == 1;
            set => control.ChipSelectChange = value
                ? (byte) 1
                : (byte) 0;
        }
