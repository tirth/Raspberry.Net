...
namespace Raspberry.IO.GeneralPurpose
{
    ...
    public class ConnectedPins : IEnumerable<ConnectedPin>
    {
        ...
        /// </summary>
        public ConnectedPin this[ProcessorPin pin] => new ConnectedPin(connection, connection.GetConfiguration(pin));

        /// <summary>
        /// Gets the status of the specified pin.
        /// </summary>
        public ConnectedPin this[string name] => new ConnectedPin(connection, connection.GetConfiguration(name));
        ...
        /// Gets the status of the specified pin.
        /// </summary>
        public ConnectedPin this[PinConfiguration pin] => new ConnectedPin(connection, pin);
