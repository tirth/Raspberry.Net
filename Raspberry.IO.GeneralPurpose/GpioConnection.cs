...
namespace Raspberry.IO.GeneralPurpose
{
    ...
    public class GpioConnection : IDisposable
    {
        ...
        {
            get => this[pinConfigurations[pin]];
        ...
        internal IEnumerable<PinConfiguration> Configurations => pinConfigurations.Values;

        #endregion

        #region Private Helpers

        private IGpioConnectionDriver Driver => settings.Driver;
